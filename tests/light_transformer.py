...
class LightningTransformer(LightningModule):
    def __init__(self, vocab_size: int, ninp: int, nhead: int, nhid: int, nlayers: int, device: str) -> None:
        super().__init__()
    ...
    def val_dataloader(self) -> DataLoader:
        ...
        val_dataset = ShuffleWMTIterableDataset(Path("/home/ubuntu/inhibition/data/news.2024.small.txt"), self.vocab.most_common(MOST_COMMON_WORDS), self.dictionary, shuffle=False)
